...
const initialState = {
    ...
    blocksData: null,
    blocksNames: [
        "detector1", "amplitudeControl1",
        'hfMultiplexsor1', 'eclBuffer2', 'eclBuffer1',
        'divider1', 'divider2', 'eclToCmosBuffer1',
        'cmosCounter2', 'cmosCounter1', 'inputBuffer1',
        'passGate1', 'currentSwitch1', 'pfd1',
        "vcoBlock1",
    ],
